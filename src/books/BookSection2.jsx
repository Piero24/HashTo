                    ...
                    <div className="relative bg-gray-800 shadow-xl rounded-lg p-8 w-11/12 md:w-5/6 lg:w-3/4 mx-auto border border-yellow-500 transform transition duration-300 hover:scale-105 hover:shadow-yellow-400/50">
                        ...
                        <div className="text-gray-300 text-center leading-relaxed space-y-4">
                            ...
                            <p>
                                ...
                                We do not endorse or encourage any improper use of this list.
                            </p>
                            <p>
                                Instead, we strongly encourage users to purchase these books and courses to gain a deeper understanding of the concepts, benefit from detailed explanations, and acquire valuable insights into solving the problems effectively. 
                                Supporting the authors and creators ensures access to high-quality educational resources.
                            </p>
                        </div>
